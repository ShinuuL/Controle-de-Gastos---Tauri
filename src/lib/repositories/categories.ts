...
export async function listCategories(): Promise<Category[]> {
  return traceOperation("category.list", async () => {
...
export async function listCategoryBudgetProgress(
  ...
  return traceOperation("category.listBudgetProgress", async () => {
    const db = await getDb();
...
export async function createCategory(
  ...
  return traceOperation("category.create", async () => {
...
export async function updateCategoryBudget(
  ...
  return traceOperation("category.updateBudget", async () => {
